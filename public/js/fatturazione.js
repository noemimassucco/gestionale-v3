  ...
  container.innerHTML = `
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
      ...
      <div>
        ...
        <div class="detail-row"><span>Importo</span><strong style="font-size:18px;color:var(--gold);font-family:monospace;">€ ${parseFloat(obj.importo||0).toLocaleString('it-IT',{minimumFractionDigits:2})}</strong></div>
    ...
    <div style="display:flex;gap:8px;margin-top:16px;padding-top:12px;border-top:1px solid var(--border);">
      ...
      <button class="btn btn-sm" style="background:rgba(37,99,235,.15);color:#93c5fd;" onclick="closeM('modal-fatt-detail');openEditFatt(${obj.id})">✏️ Modifica</button>
