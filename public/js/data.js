...
function renderTbSubs() {
  ...
  tb.innerHTML = DB.subs.map(s => {
    ...
    const istatBadge = istatDue ? '<span title="Aggiornamento ISTAT necessario" style="font-size:10px;background:rgba(184,134,11,.2);color:var(--accent-bg);padding:1px 5px;border-radius:8px;margin-left:4px;">📈 ISTAT</span>' : '';
