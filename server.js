...
// ═══════════════════════════════════════════════════════════
app.get('/api/fatturazione', authMiddleware, async (req, res) => {
...
app.post('/api/fatturazione', authMiddleware, async (req, res) => {
  const f = req.body;
  try {
    const r = await pool.query(
...
app.put('/api/fatturazione/:id', authMiddleware, async (req, res) => {
  const f = req.body;
  try {
    const r = await pool.query(
...
app.delete('/api/fatturazione/:id', authMiddleware, async (req, res) => {
  await pool.query('DELETE FROM ordini_fatturazione WHERE id=$1',[req.params.id]);
  res.json({ok:true});
});

app.post('/api/fatturazione/:id/paga', authMiddleware, async (req, res) => {
...
app.post('/api/fatturazione/:id/contabilizza', authMiddleware, async (req, res) => {
...
app.get('/api/fatturazione/export', authMiddleware, async (req, res) => {
...
app.post('/api/fatturazione/reimport', authMiddleware, async (req, res) => {
  const {rows}=req.body;
...
app.put('/api/subs/:id/istat', authMiddleware, async (req, res) => {
...
app.get('/api/fatturazione/istat-alert', authMiddleware, async (req, res) => {
  try {
    const r=await pool.query(`
